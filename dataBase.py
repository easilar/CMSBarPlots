...
T2cc		  = pp+'#tilde{t}#tilde{t}, #tilde{t} #rightarrow c  #tilde{#chi}_{1}^{0}'
T6bbHH = pp+'#tilde{b}#tilde{b}, #tilde{b} #rightarrow b  #tilde{#chi}_{2}^{0}#rightarrow b H#tilde{#chi}_{1}^0'

T6bbWW 		  = pp+'#tilde{t}#tilde{t}, #tilde{t}#rightarrow #tilde{#chi}_{1}^{#pm} b #rightarrow b W^{#pm} #tilde{#chi}_{1}^{0}'
...
all_analysis["Gluino"]['16-020-16-035-T1tttt'] ={'pos':11,'search':'2l same-sign','max': {'050': [1370, 'SUS-16-020 , SUS-16-035', sqrt, lumi], 'Mor':1530},  'decay': T1tttt, }
all_analysis["Gluino"]['16-022-16-041-T1tttt'] ={'pos':12,'search':'multilepton', 'max': {'050': [1200, 'SUS-16-022 , SUS-16-041',  sqrt, lumi], 'Mor':1630},  'decay': T1tttt, }
...
all_analysis["Gluino"]['16-030-T5tctc']        ={'pos':15,'search':'0l', 	   	 'max'  : {'050': [1500, 'SUS-16-030',   sqrt, lumi]},  'decay': T5tctc, 'comm':D_SUS_16_030}
all_analysis["Gluino"]['16-033-T1btbt']        ={'pos':16,'search':'0l(MHT)', 	 'max'  : {'050': [0, 'SUS-16-033 ',   sqrt, lumi],'Mor':1760},  'decay': T1btbt, 'comm':T1btbt_Comm }
all_analysis["Gluino"]['16-019-16-042-T5WW']   ={'pos':17,'search':'1l(#Delta#phi)','max'  : {'050': [1600, 'SUS-16-019 , SUS-16-042',   sqrt, lumi] , 'Mor':1900},  'decay': T5WW, 'x':0.5  }


all_analysis["Gluino"]['16-020-16-035-T5WW']   = {'pos':18,'search':'2l same-sign',  'max'  : {'050': [1100, 'SUS-16-020 , SUS-16-035',   sqrt, lumi],'Mor':1280},  'decay': T5WW, 'x':0.5 }
all_analysis["Gluino"]['16-020-16-035-T5WWDelta20'] = {'pos':19,'search':'2l same-sign',  'max'  : {'050': [1100, 'SUS-16-020 , SUS-16-035',   sqrt, lumi],'Mor':1430},  'decay': T5WW, 'comm':'('+D_I +'20 GeV)'  }
all_analysis["Gluino"]['16-014-16-033-T5VV']   = {'pos':20,'search':'0l(MHT)', 	 'max'  : {'050': [1625, 'SUS-16-014 , SUS-16-033',   sqrt, lumi], 'Mor':1800},  'decay': T5VV, 'x':0.5}
all_analysis["Gluino"]['16-022-16-041-T5VV']   = {'pos':21,'search':'multilepton',   'max'  : {'050': [1010, 'SUS-16-022',   sqrt, lumi], 'Mor':1160},  'decay': T5VV, 'x':0.5}
all_analysis["Gluino"]['line']                 = {'pos':22, 'search':'', 		   'max'  : {'050': [0.0, '' , 0 , 0   ]}, 'min': {}, 'decay': ''  ,     'delta': {'050': [0.0,''         , 0 , 0]}}
...
all_analysis["Squark"]['16-049-T2cc']            ={'pos':10,'search':'0l', 		'max'  : {'050': [0, 'SUS-16-049',  sqrt, lumi], 'Mor':570},     'decay': T2cc, 'comm':'('+D_M +'40 GeV)' }
all_analysis["Squark"]['16-025-16-035-T2bbWWoff']={'pos':11,'search':'2l soft' , 'max'  : {'050': [365, 'SUS-16-025 , SUS-16-035',  sqrt, lumi], 'Mor':450},    'decay': T2bbWWoff, 'comm':'('+D_M +'40 GeV)'    ,}
all_analysis["Squark"]['16-029-16-049-T2bbWWoff']={'pos':12,'search':'0l',    'max'  : {'050': [450, 'SUS-16-029 , 16-049',  sqrt, lumi],'Mor':550},    'decay': T2bbWWoff,  'comm':'('+D_M +'50 GeV)'     , }
all_analysis["Squark"]['16-031-T2bbWWoff']       ={'pos':13,'search':'1l soft','max': {'050': [330, 'SUS-16-031',  sqrt, lumi]},'decay': T2bbWWoff, 'comm':'('+D_M +'30 GeV)',}

#all_analysis["Squark"]['16-036-T6bbWW']    = {'pos':8,'search':'0l(MT2)', 		'max'  : {'050': [0, 'SUS-16-036',  sqrt, lumi], 'Mor':900},     'decay': T6bbWW,'x':0.5 }
all_analysis["Squark"]['16-028-16-051-T6bbWW']   ={'pos':14,'search':'1l', 	'max': {'050': [760, 'SUS-16-028 , SUS-16-051',  sqrt, lumi],'Mor':1000},  'decay': T6bbWW, 'x':0.5}
all_analysis["Squark"]['16-029-16-049-T6bbWW']   ={'pos':15,'search':'0l', 	'max'  : {'050': [710, 'SUS-16-029 , SUS-16-049',  sqrt, lumi],'Mor':750},  'decay': T6bbWW, 'x':0.5}
all_analysis["Squark"]['16-036-T6bbWW']          ={'pos':16,'search':'0l(MT2)', 'max'  : {'050': [0, 'SUS-16-036',  sqrt, lumi],'Mor':900},  'decay': T6bbWW, 'x':0.5}
all_analysis["Squark"]['17-001-T6bbWW']          ={'pos':17,'search':'2l opposite-sign', 'max'  : {'050': [0, 'SUS-16-036',  sqrt, lumi],'Mor':900},  'decay': T6bbWW, 'x':0.5}

'''
Sbottom
'''
all_analysis["Squark"]['16-014-16-033-T2bb']     ={'pos':18,'search':'0l(MHT)', 	'max'  : {'050': [790,  'SUS-16-014 , SUS-16-033',  sqrt, lumi],'Mor':1040},'decay': T2bb,}
all_analysis["Squark"]['16-015-16-036-T2bb']     ={'pos':19,'search':'0l(MT2)', 	'max'  : {'050': [1030, 'SUS-16-015 , SUS-16-036',  sqrt, lumi],'Mor':1170},'decay': T2bb,    }
all_analysis["Squark"]['16-016-T2bb']            ={'pos':20,'search':'0l(#alpha_{T})',	'max'  : {'050': [1020, 'SUS-16-016',  sqrt, lumi]},	'decay': T2bb, }
all_analysis["Squark"]['16-032-T2bb']            ={'pos':21,'search':'0l', 		'max'  : {'050': [0,    'SUS-16-032',  sqrt, lumi],'Mor':1235},	'decay': T2bb,    }
...
all_analysis["Squark"]['16-014-16-033-T2-squark']={'pos':22,'search':'0l(MHT)','max'  : {'050': [1160, 'SUS-16-014 , SUS-16-033',sqrt, lumi],'Mor':1450},   'decay': T2, 'rightlabel': squarks }
all_analysis["Squark"]['16-015-16-036-T2-squark']={'pos':22,'search':'0l(MT2)','max'  : {'050': [1400, 'SUS-16-015 , SUS-16-036',sqrt, lumi],'Mor':1550},   'decay': T2, 'rightlabel': squarks }
...
all_analysis["EWKGauginos"]['16-024-16-039-TChiChipmSlepL05']={'pos':2,'search':'multilepton (flavour democratic)', 'max'  : {'050': [980, 'SUS-16-024 , SUS-16-039',  sqrt, lumi],'Mor':1140}, 
'decay': TChiChipmSlepL, 'x':0.5}
#all_analysis["EWKGauginos"]['16-024-16-039-TChiChipmSlepL005']  = {'pos':3,'search':'multilepton + 2l same-sign (flavour democratic)', 'max'  : {'050': [990, 'SUS-16-024 , SUS-16-039',  sqrt, lumi],'Mor':1130},'decay': TChiChipmSlepL, 'x':0.05}
all_analysis["EWKGauginos"]['16-039-TChiChipmSlepL095']      ={'pos':3,'search':'multilepton + 2l same-sign (flavour democratic)', 'max'  : {'050': [0, 'SUS-16-039',  sqrt, lumi],'Mor':1040},'decay':TChiChipmSlepL, 'x':0.95}

#all_analysis["EWKGauginos"]['16-024-16-039-TChiChipmSlepStau005']   = {'pos':5,'search':'multilepton (tau enriched)', 'max'  : {'050': [0, 'SUS-16-039',  sqrt, lumi],'Mor':1030},'decay': TChiChipmSlepStau, 'x':0.5}
#all_analysis["EWKGauginos"]['16-024-16-039-TChiChipmSlepStau050']  = {'pos':6,'search':'multilepton (tau enriched)', 'max'  : {'050': [0, 'SUS-16-039',  sqrt, lumi],'Mor':1080}, 'decay': TChiChipmSlepStau, 'x':0.05}
#all_analysis["EWKGauginos"]['16-039-TChiChipmSlepStau095']   ={'pos':4,'search':'multilepton (tau enriched)', 'max'  : {'050': [0, 'SUS-16-039',  sqrt, lumi],'Mor':1050},'decay': TChiChipmSlepStau, 'x':0.95}

all_analysis["EWKGauginos"]['16-039-TChiChipmStauStau']      ={'pos':5,'search':'Multilepton (tau dominated)', 'max'  : {'050': [0, 'SUS-16-039',  sqrt, lumi],'Mor':625}, 'decay': TChiChipmStauStau, 'x':0.5}
...
all_analysis["EWKGauginos"]['16-024-16-039-TChiWZ']          ={'pos':6,'search':'multilepton', 'max'  : {'050': [375, 'SUS-16-024 , SUS-16-039',  sqrt, lumi],'Mor':450}, 'decay': TChiWZ,}
all_analysis["EWKGauginos"]['16-024-TChiWH']                 ={'pos':7,'search':'Multilepton', 'max'  : {'050': [0, 'SUS-16-039',  sqrt, lumi],'Mor':180},  'decay': TChiWH, }
#all_analysis["EWKGauginos"]['16-024-TChiWH']       = {'search':'Multilepton', 'max'  : {'050': [150, 'SUS-16-024',  sqrt, lumi]},  'decay': TChiWH, }
all_analysis["EWKGauginos"]['16-025-16-048-TChiWZ']          ={'pos':8,'search':'2l soft', 'max'  : {'050': [195, 'SUS-16-025 , SUS-16-048',  sqrt, lumi],'Mor':230},  'decay': TChiWZ, 'comm':'('+D_M +'20 GeV)'}
all_analysis["EWKGauginos"]['']           	             ={'pos':9,'search':'', 'max'  : {'050': [0.0, '', 0 , 0   ]}, 'decay': ''  ,    }
